...
# the last 13 days of simulation for two different agents, i. e. two 
# different combination of parameters. As each day is equivalent to 24 
# simulation steps, 13 days equals 312 steps which are the steps where 
...
SheetName1 = "Rule=0.125-CM=FC--A-PBC"
SheetName2 = "Rule=0.5-CM=FC--A"
